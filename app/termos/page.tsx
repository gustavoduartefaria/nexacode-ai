  ...
  return (
    <main className="legal-page">
      ...
      <article>
        ...
        <section><h2>4. Inteligência artificial</h2><p>O mentor informa na interface se a resposta veio do motor didático local ou de uma integração remota configurada. Respostas podem conter imprecisões e devem ser verificadas com execução, testes e documentação técnica. O uso possui limites conforme o plano.</p></section>
