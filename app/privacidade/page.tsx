  ...
  return (
    <main className="legal-page">
      ...
      <article>
        ...
        <section><h2>3. Prestadores</h2><p>A Vercel entrega o frontend, o Railway executa o backend e o Supabase hospeda o PostgreSQL. A Cakto processa pagamentos e o Resend entrega e-mails transacionais. Cada prestador recebe somente os dados necessários à sua função.</p></section>
        ...
        <section><h2>6. Segurança e retenção</h2><p>Usamos sessões HTTP-only, limitação de tentativas, auditoria, separação por usuário e HTTPS em produção. Dados são mantidos enquanto a conta estiver ativa ou pelo prazo necessário ao cumprimento legal.</p></section>
